...
\begin{slidenote}{Web Application Prototype}
\Purpose
...
\KeyPoints
\begin{itemize}
  \item The application connects frontend, backend, material catalog, and model services.
  \item It supports source--probe setup and model-route comparison.
  \item Results are displayed as normalized thermal, mechanical, directional, and temporal responses.
\end{itemize}
