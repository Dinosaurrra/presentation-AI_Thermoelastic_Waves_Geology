...
\begin{frame}{COMSOL Simulation Results}
  \begin{columns}[T,onlytextwidth]
    ...
    \begin{column}{0.332\textwidth}
      ...
      \vspace{1mm}
      {\scriptsize Thermal expansion produces displacement concentrated
...
\begin{frame}{PINN Input and Architecture}
  ...
  \begin{columns}[T]
    ...
    \begin{column}{0.40\textwidth}
      ...
      components. Inputs and supervised outputs are standardized. Velocity,
      stress, and strain are derived through autograd during residual and
      velocity-consistency evaluation.}
    \end{column}
  \end{columns}
\end{frame}
