...
\setbeamertemplate{footline}{%
  \leavevmode
  \hbox{%
    \begin{beamercolorbox}[wd=.72\paperwidth,ht=4.4ex,dp=1ex,leftskip=8mm]{footline}%
      \color{AcademicMuted}%
      \begin{tabular}{@{}l@{}}
      ...
      \end{tabular}
    \end{beamercolorbox}%
    \begin{beamercolorbox}[wd=.28\paperwidth,ht=4.4ex,dp=1ex,right,rightskip=8mm]{footline}%
