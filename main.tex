% main.tex -- Artificial Intelligence-Assisted Directional Prediction of Thermoelastic Wave
...
\title[AI-Assisted Thermoelastic Prediction]{%
  Artificial Intelligence-Assisted Directional Prediction of Thermoelastic Wave Propagation%
  \texorpdfstring{\\}{ }%
  in Geological Media%
}
...
\begin{frame}{Relevance of the Topic}
  ...
  \begin{exampleblock}{Working position of this thesis}
    ...
    \emph{artificial intelligence (AI)-assisted directional prediction} of thermoelastic wave
...
\begin{frame}{Research Problem}
  \begin{exampleblock}{Problem statement}
    ...
    artificial intelligence (AI)-assisted comparative framework under simplified physical assumptions.
  \end{exampleblock}
  \vskip 6pt
  \begin{itemize}
...
\begin{frame}{Aim and Tasks}
  \begin{block}{Aim}
    To develop and justify an artificial intelligence (AI)-assisted framework for directional
...
\begin{frame}{Object and Subject of the Study}
  \begin{columns}[T]
    ...
    \begin{column}{0.48\textwidth}
      \begin{block}{Subject}
        artificial intelligence (AI)-assisted directional prediction of thermal and displacement
...
\begin{frame}{Shared Model Comparison Contract}
  \begin{block}{Common interpretation}
    ...
    AI-assisted directional prediction task, not as complete numerical solvers.
  \end{block}
  \begin{columns}[T]
