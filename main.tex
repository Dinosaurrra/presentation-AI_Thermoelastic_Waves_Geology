...
\begin{frame}{Relevance of the Topic}
  ...
  \begin{exampleblock}{Working position of this thesis}
    ...
    \emph{AI-guided directional prediction}, not a complete
...
\begin{frame}{Object and Subject of the Study}
  \begin{columns}[T]
    ...
    \begin{column}{0.48\textwidth}
      \begin{block}{Subject}
        AI-guided directional prediction of thermal and displacement
...
\begin{frame}{Primary Fields in the 2D Model}
  ...
  \vskip 8pt
  \normalsize
  These fields connect the physical formulation from Chapters 1--2 with
  the prediction methodology of Chapter 3.
\end{frame}
